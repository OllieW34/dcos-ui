...
class GeneralFormSection extends Component<GeneralProps, object> {
        ...
        <FormGroup className="column-3">
          <FieldLabel className="text-no-transform">
            <FormGroupHeading required={true}>
              ...
              <FormGroupHeadingContent title="Mem Info">
                <Tooltip
                  content={memTooltipContent}
                  interactive={true}
                  maxWidth={300}
                  wrapText={true}
                >
        ...
        <FormGroup className="column-3">
          <FieldLabel className="text-no-transform">
            <FormGroupHeading required={true}>
              ...
              <FormGroupHeadingContent title="Disk Info">
                <Tooltip
                  content={diskTooltipContent}
                  interactive={true}
                  maxWidth={300}
                  wrapText={true}
                >
  ...
  render() {
    ...
    const descTooltipContent = "A description of this job.";
